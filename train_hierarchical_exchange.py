...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm_config_path", type=str, required=True)
    parser.add_argument("--use_tune", type=bool, default=True)
    parser.add_argument("--project_name", type=str, default="testing_callback_grid")
    ...
    parser.add_argument("--grace_period", type=int, default=400)
    parser.add_argument("--num_iters_no_improvement", type=int, default=200)
    parser.add_argument("--seed", type=int, default=-1)
    parser.add_argument("--with_opponent", type=bool, default=-1)
    ...
    if args.use_tune:
        ...
        stopper = tune.stopper.CombinedStopper(
            tune.stopper.MaximumIterationStopper(max_iter=args.num_iters),
